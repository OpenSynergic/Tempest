                    ...
                    <div class="max-w-[1400px] mx-auto">
                        ...
                        <div class="space-y-12 sm:space-y-16 md:space-y-20">
                            ...
                            <div class="bg-white p-4 sm:p-6 md:p-8 lg:p-12 rounded-2xl sm:rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6 md:gap-8 justify-items-center">
                                    @foreach($sponsorsWithoutLevel as $sponsor)
                                    @if(!$sponsor->getFirstMedia('logo'))
                                    @continue
                                    @endif
                                    <div class="w-full">
                                        <div class="bg-white h-24 sm:h-28 md:h-32 p-4 sm:p-5 md:p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center border border-gray-100">
                            ...
                            <div class="bg-white p-4 sm:p-6 md:p-8 lg:p-12 rounded-2xl sm:rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                                <h3 class="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 md:mb-10 relative inline-block 
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6 md:gap-8 justify-items-center">
                                    ...
                                    @endif
                                    <div class="w-full"> 
                                        <div class="h-24 sm:h-28 md:h-32 p-4 sm:p-5 md:p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center border border-gray-100
                        ...
                        <div class="px-4 mx-auto container">
                            <div class="max-w-7xl mx-auto">
                                ...
                                <div class="bg-white p-6 sm:p-8 md:p-10 lg:p-12 rounded-2xl sm:rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8 justify-items-center">
                                        @foreach($partners as $partner)
                                            <div class="w-full max-w-[240px] sm:max-w-full">
                                                <div class="bg-gradient-to-b from-white to-gray-50/50 h-24 sm:h-28 md:h-32 p-2 sm:p-3 md:p-4 rounded-lg sm:rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center border border-gray-100">
                                                    <img class="w-full h-full object-contain"
