<div class="banner relative overflow-hidden -mt-[5%] mb-[4%] z-10">
    ...
    @else
        <div class="w-full h-auto aspect-[16/7] bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-500 animate-gradient"></div>
    @endif
    ...
    <div class="conference-title relative z-10 flex flex-col text-white p-4 md:p-8 lg:p-12 xl:p-16 -mt-[4%] ml-[2%]">
        <!-- Conference Title -->
        <h1 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 text-shadow-lg -mt-[28%] mr-[48%] md:mr-[30%] lg:mr-[40%] text-white z-20">
            {{ $currentScheduledConference->title ?? 'Conference Title' }}
        </h1>
        
        <!-- Date Information -->
        <p class="text-lg md:text-xl lg:text-2xl mb-6 opacity-90 flex items-center backdrop-blur-sm bg-black/10 rounded-lg px-4 py-2 w-fit">
        ...
        <p class="text-lg md:text-xl lg:text-2xl mb-8 opacity-90 flex items-center backdrop-blur-sm bg-black/10 rounded-lg px-4 py-2 w-fit">
            <svg class="w-6 h-6 inline-block mr-3 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Countdown Section -->
        <div class="w-full max-w-5xl mx-auto mt-14 backdrop-blur-md bg-white rounded-2xl border border-white/20 shadow-2xl p-6"
